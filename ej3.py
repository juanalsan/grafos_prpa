...
def ejercicio3_grafos(spc, filenames):
    """
calcula los 3-ciclos locales a cada uno de los ficheros de la lista de ficheros de entrada. 
    ...
    for filename in filenames :
        ...
        triciclos_locales_lst.extend(triciclos_locales)
    print(triciclos_locales_lst)
    
    return triciclos_locales_lst
